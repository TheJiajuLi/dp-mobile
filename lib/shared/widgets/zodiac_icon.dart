...
// 星座选择器 Widget
class ZodiacPicker extends StatelessWidget {
  final ZodiacSign? selected;
  final ValueChanged<ZodiacSign> onSelected;

  const ZodiacPicker({super.key, this.selected, required this.onSelected});
            ...
            children: [
              Container(
                decoration: isSelected
                    ...
                    : null,
                child: ZodiacIcon(sign: sign, size: 60),
              ),
              const SizedBox(height: 4),
              Text(
                sign.chineseName.replaceAll('座', ''),
                style: TextStyle(
                  fontSize: 11,
                  color: isSelected ? const Color(0xFF6366F1) : const Color(0xFF8E8E93),
